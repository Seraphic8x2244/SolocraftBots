...
-- Preset-over-preset rebuild transition barrier. This now belongs to the
-- authoritative Spawn owner so teardown, conversion, settle and handoff live
-- in the same state-machine module as the summon scheduler.
